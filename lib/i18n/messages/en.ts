...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.fontSmaller": "Smaller terminal text",
    "terminal.fontLarger": "Larger terminal text",
    ...
    "files.selectSession": "Open a conversation to browse its files",
    ...
    "chat.uploadConfirmLarge": "\"{name}\" is {size}. Upload it anyway?",
    "chat.uploadNoAutoInline": "Files over 5MB won't be auto-read by the agent — it can still read the file from disk.",
    "chat.uploadFailed": "Failed to upload {name}",
    "chat.fileMentionHeader": "Referenced files",
    "chat.fileMentionLines": "{count} lines",
    "chat.fileMentionSkippedTooLarge": "Skipped — file too large",
    "chat.fileMentionSkippedBinary": "Skipped — binary file",
    "chat.imageAttachTooLarge": "Skipped {count} image(s) over {maxMB}MB: {names}",
    "chat.imageAttachUnsupported": "Skipped {count} unsupported file(s): {names}",
    "chat.imageAttachLimit": "Only {max} images allowed per message; skipped {count} extra image(s)",
    ...
    "roles.backups": "Backups",
    "roles.backupsInherited": "inherited from default",
    "roles.backupsNone": "no backups",
    "roles.backupsAdd": "Add a backup model",
    "roles.backupsOverride": "Override",
    "roles.backupsOverrideHint": "Give this role its own chain instead of the default one",
    "roles.backupsReset": "Use default",
    "roles.backupsResetHint": "Remove this role's chain so the default chain covers it again",
    "roles.backupsRemove": "Remove backup",
    "roles.backupsUp": "Move earlier",
    "roles.backupsDown": "Move later",
    "roles.backupsHint": "Ordered failover. omp moves to the next entry when the one before it is rate-limited, out of quota, or erroring.",
    "roles.rotation": "Rotate per conversation",
    "roles.rotationHint": "Each new conversation starts on the next model in this role's pool, then stays on it for its whole life so the provider's prompt cache keeps working. The rest of the pool becomes that conversation's failover order.",
    "roles.rotationOn": "Rotate this role",
    "roles.rotationOff": "Do not rotate this role",
    "roles.rotationNeedsPool": "Needs at least one backup to rotate between",
    ...
    "nav.loading.auth": "Signing you in…",
    "nav.loading.machines": "Loading machines…",
    "nav.loading.projects": "Loading projects…",
    "nav.loading.session": "Opening conversation…",
    "accessNotice.machine.not-found.title": "Machine not found",
    "accessNotice.machine.not-found.body": "This machine id doesn't exist on the fleet. Check the link, or switch to a machine you can see.",
    "accessNotice.machine.no-permission.title": "No access to this machine",
    "accessNotice.machine.no-permission.body": "This machine exists, but it hasn't been granted to your account. Ask an admin for access, or switch machines.",
    "accessNotice.machine.offline.title": "Machine unreachable",
    "accessNotice.machine.offline.body": "This machine didn't respond. It may be offline, or unreachable from this gateway.",
    "accessNotice.project.not-available.title": "Project not available",
    "accessNotice.project.not-available.body": "This project doesn't exist, or isn't visible to your account.",
    "accessNotice.session.not-available.title": "Conversation not available",
    "accessNotice.session.not-available.body": "This conversation doesn't exist, or isn't visible to your account.",
    "accessNotice.cta.retry": "Retry",
    "accessNotice.cta.goLocal": "Go to local machine",
    "accessNotice.forbidden": "Fleet management requires an admin account.",
    "accessNotice.adminOnly": "This section requires an admin account.",
    "accessNotice.noVisibleSessions": "No projects or conversations are visible to your account yet. Ask an admin to grant you access.",
    "home.title": "Home",
    "home.welcome.title": "Welcome to omp",
    "home.welcome.body": "Pick a project to see its weekly conversation calendar, or open a conversation from the list below.",
    "home.quickAccess": "Quick access",
    "home.noProjects": "No projects with conversations yet on this machine.",
    "home.machineOffline": "unreachable",
    "home.openMachine": "Open {name}",
    "home.refresh": "Refresh",
    "home.currentWeek": "This week",
    "home.previousWeek": "Previous week",
    "home.nextWeek": "Next week",
    "home.noConversationsThisWeek": "No conversations this week.",
    ...
    "home.viewAggregate": "All machines",
    "home.viewSingleMachine": "Single machine",
    "home.turnCount": "~{count} turns",
    "home.sessionCount": "{count} conversations",
    "home.machineCountLabel": "{count} machines",
    "home.aggregateEmpty": "No projects with conversations across the fleet yet.",
    "home.recentActivity": "Recent activity",
    "home.showAllConversations": "Show all {count} conversations",
    "home.expandProject": "Expand {project}",
    "home.collapseProject": "Collapse {project}",
    "sidebar.expandStrip": "Expand sidebar",
    "sidebar.stripLabel": "Collapsed sidebar",
    "sidebar.openConversation": "Open {title}",
    "sidebar.openDrawer": "Expand detail view",
    "sidebar.closeDrawer": "Collapse to compact view",
    "sidebar.columnTitle": "Title",
    "sidebar.columnMessages": "Messages",
    "sidebar.columnStatus": "Status",
    "sidebar.columnSize": "Size",
    "sidebar.columnBranch": "Branch",
    "sidebar.columnActions": "Actions",
    ...
    "sidebar.status.pending": "In progress",
    "sidebar.status.unknown": "Unknown",
    "sidebar.issueTitleResolving": "Resolving…",
    "sidebar.resummarizeTitle": "Regenerate this session's title",
  },
};
