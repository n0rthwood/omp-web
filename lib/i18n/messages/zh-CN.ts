...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.noFiles": "未找到文件",
    "files.selectSession": "打开一个会话以浏览其文件",
    ...
    "chat.uploading": "正在上传…",
    "chat.uploadConfirmLarge": "“{name}” 大小为 {size}，仍要上传吗？",
    "chat.uploadNoAutoInline": "超过 5MB 的文件不会被 Agent 自动读取——但 Agent 仍可从磁盘读取该文件。",
    "chat.uploadFailed": "上传 {name} 失败",
    "chat.fileMentionHeader": "引用的文件",
    "chat.fileMentionLines": "{count} 行",
    "chat.fileMentionSkippedTooLarge": "已跳过 — 文件过大",
    "chat.fileMentionSkippedBinary": "已跳过 — 二进制文件",
    "chat.imageAttachTooLarge": "已跳过 {count} 张超过 {maxMB}MB 的图片：{names}",
    "chat.imageAttachUnsupported": "已跳过 {count} 个不支持的文件：{names}",
    "chat.imageAttachLimit": "每条消息最多可附加 {max} 张图片，已跳过 {count} 张多余图片",
    ...
    "roles.backups": "备用模型",
    "roles.backupsInherited": "继承自 default",
    "roles.backupsNone": "无备用模型",
    "roles.backupsAdd": "添加备用模型",
    "roles.backupsOverride": "单独配置",
    "roles.backupsOverrideHint": "为该角色配置独立的备用链，不再使用 default",
    "roles.backupsReset": "使用 default",
    "roles.backupsResetHint": "移除该角色的备用链，重新由 default 覆盖",
    "roles.backupsRemove": "移除备用模型",
    "roles.backupsUp": "上移",
    "roles.backupsDown": "下移",
    "roles.backupsHint": "按顺序故障转移。当前一个模型限流、超额或报错时，omp 会切换到下一个。",
    "roles.rotation": "按会话轮换",
    "roles.rotationHint": "每个新会话从该角色模型池中的下一个模型开始，并在整个会话生命周期内保持不变，以便复用服务商的提示缓存。池中其余模型成为该会话的故障转移顺序。",
    "roles.rotationOn": "轮换该角色",
    "roles.rotationOff": "不轮换该角色",
    "roles.rotationNeedsPool": "至少需要一个备用模型才能轮换",
    ...
    "nav.loading.auth": "正在登录…",
    "nav.loading.machines": "正在加载机器列表…",
    "nav.loading.projects": "正在加载项目…",
    "nav.loading.session": "正在打开会话…",
    "accessNotice.machine.not-found.title": "未找到该机器",
    "accessNotice.machine.not-found.body": "该机器 ID 在集群中不存在。请检查链接，或切换到你可见的机器。",
    "accessNotice.machine.no-permission.title": "无权访问该机器",
    "accessNotice.machine.no-permission.body": "该机器存在，但尚未授权给你的账户。请联系管理员申请权限，或切换机器。",
    "accessNotice.machine.offline.title": "机器无法访问",
    "accessNotice.machine.offline.body": "该机器没有响应，可能已离线或从本网关无法访问。",
    "accessNotice.project.not-available.title": "项目不可用",
    "accessNotice.project.not-available.body": "该项目不存在，或对你的账户不可见。",
    "accessNotice.session.not-available.title": "会话不可用",
    "accessNotice.session.not-available.body": "该会话不存在，或对你的账户不可见。",
    "accessNotice.cta.retry": "重试",
    "accessNotice.cta.goLocal": "前往本机",
    "accessNotice.forbidden": "集群管理需要管理员账户。",
    "accessNotice.adminOnly": "此部分需要管理员账户。",
    "accessNotice.noVisibleSessions": "你的账户目前没有可见的项目或会话，请联系管理员申请权限。",
    "home.title": "主页",
    "home.welcome.title": "欢迎使用 omp",
    "home.welcome.body": "选择一个项目查看其每周会话日历，或从下方列表打开会话。",
    "home.quickAccess": "快速访问",
    "home.noProjects": "此机器上还没有包含会话的项目。",
    "home.machineOffline": "无法连接",
    "home.openMachine": "打开 {name}",
    "home.refresh": "刷新",
    "home.currentWeek": "本周",
    "home.previousWeek": "上一周",
    "home.nextWeek": "下一周",
    "home.noConversationsThisWeek": "本周没有会话。",
    ...
    "home.startedAt": "开始",
    "home.viewMode": "视图模式",
    "home.viewAggregate": "全部机器",
    "home.viewSingleMachine": "单台机器",
    "home.turnCount": "~{count} 轮",
    "home.sessionCount": "{count} 个会话",
    "home.machineCountLabel": "{count} 台机器",
    "home.aggregateEmpty": "整个 fleet 还没有包含会话的项目。",
    "home.recentActivity": "最近动态",
    "home.showAllConversations": "显示全部 {count} 个会话",
    "home.expandProject": "展开 {project}",
    "home.collapseProject": "收起 {project}",
    "sidebar.expandStrip": "展开侧边栏",
    "sidebar.stripLabel": "已收起的侧边栏",
    "sidebar.openConversation": "打开 {title}",
    "sidebar.openDrawer": "展开详情视图",
    "sidebar.closeDrawer": "收起为紧凑视图",
    "sidebar.columnTitle": "标题",
    "sidebar.columnMessages": "消息数",
    "sidebar.columnStatus": "状态",
    "sidebar.columnSize": "大小",
    "sidebar.columnBranch": "分支",
    "sidebar.columnActions": "操作",
    "sidebar.status.complete": "已完成",
    "sidebar.status.interrupted": "已中断",
    "sidebar.status.aborted": "已中止",
    "sidebar.status.error": "出错",
    "sidebar.status.pending": "进行中",
    "sidebar.status.unknown": "未知",
    "sidebar.issueTitleResolving": "解析中…",
    "sidebar.resummarizeTitle": "重新生成该会话的标题",
  },
};
